...
// Calcule un prix cohérent avec les tarifs réellement configurés dans Paramètres (settings),
// au lieu d'un montant codé en dur — utilisé uniquement pour générer les fausses réservations de test.
function fakePrix(type, discipline, heureDebut, heureFin, dateKey, settings) {
        ...
        <div style={{ background: C.card, border: `1px solid ${C.iceLine}`, borderRadius: 14, overflow: 'hidden' }}>
          <div className="cal-scroll" ref={scrollRef}>
            ...
            <div style={{ display: 'flex' }}>
              ...
              <div style={{ width: 52, flexShrink: 0, position: 'sticky', left: 0, zIndex: 20, background: C.card, pointerEvents: 'none' }} />
    ...
    <div className="app-root" style={{ background: C.snow, fontFamily: 'Inter, sans-serif', color: C.ink }}>
      ...
      <main className="main-content">
        {loading ? (
          ...
          <ReservationsView reservations={realReservations} onNew={() => openNew()} onEdit={openEdit} onSeedFake={() => handleSave(generateFakeReservations(settings))} C={C} devise={settings.devise} langue={settings.langue} />
        ) : tab === 'clients' ? (
